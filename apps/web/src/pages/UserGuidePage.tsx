        ...
        <main className="lg:col-span-3 space-y-10 text-slate-800 dark:text-slate-200">
          ...
          <section id="sec-1" className="scroll-mt-6 border-b border-slate-200 pb-8 dark:border-slate-800">
            ...
            <div className="space-y-4 text-sm leading-relaxed">
              ...
              <p className="text-slate-600 dark:text-slate-300">
                한 번 로그인하면 **12시간 동안** 유지됩니다. 이 시간은 로그인한 순간부터 재며, 중간에 계속
                작업한다고 해서 저절로 늘어나지는 않습니다.
              </p>
              <ul className="list-disc pl-5 space-y-1 text-slate-600 dark:text-slate-300">
                <li>
                  **남은 시간 표시**: 남은 시간이 30분 이하로 줄면 화면 오른쪽 위, 이름 왼쪽에 남은 시간이
                  나타납니다. 10분 이하가 되면 붉은색으로 바뀝니다. 여유가 있을 때는 표시되지 않습니다.
                </li>
                <li>
                  **연장 창**: 만료 10분 전에 화면 가운데로 **로그인 시간이 곧 만료됩니다** 창이 뜹니다.
                  남은 시간이 초 단위로 줄어드는 것이 보입니다.
                </li>
                <li>
                  **로그인 연장**을 누르면 그 시점부터 다시 12시간을 확보합니다. 연장 횟수에 제한은 없습니다.
                  **지금 로그아웃**을 누르면 곧바로 로그아웃됩니다.
                </li>
              </ul>
          ...
          <section id="sec-3" className="scroll-mt-6 border-b border-slate-200 pb-8 dark:border-slate-800">
            ...
            <div className="space-y-4 text-sm leading-relaxed">
              ...
              <ul className="list-disc pl-5 space-y-1 text-slate-600 dark:text-slate-300">
                ...
                <li>**기본 정렬**: 헤더로 정렬을 고르기 전에는 **가장 최근에 수정한 프로젝트가 맨 위**에 옵니다. 손이 자주 가는 프로젝트를 목록 위쪽에서 바로 찾을 수 있습니다.</li>
                <li>**수정일**: 프로젝트 자체를 고친 때(이름·설명·보관 상태)와 **일정을 고친 때**(추가·수정·순서 변경·삭제) 중 더 최근 날짜입니다. 날짜에 마우스를 올리면 일정이 마지막으로 바뀐 시각을 분 단위까지 볼 수 있습니다. 댓글 작성은 수정일에 반영되지 않습니다.</li>
