 ...
 *
 * 담기는 인원은 **체크된 그룹들의 직속 인원 합집합**(directMembersOf)이다. 자손을 자동으로
 * 포함하던 예전 방식과 달리 여기서는 그렇게 하지 않는데, 상위를 체크할 때 자손도 명시적으로
 * 체크되므로 이중으로 셀 필요가 없고 무엇보다 **하위를 일부러 풀었을 때 그 뜻이 그대로
 * 반영되어야** 하기 때문이다.
