...
## 1. 현재 상태 (M0 + M1 + M2a + M2b + M2c + M3a + M3b + M3c + M3d + v1.2 + v1.3 + v1.4 + v1.5 + v1.6 + 2026-09 요청 1·2·3·4차 완료)
...
> 갈리기 때문이다. `scripts/cleanup-test-projects.mjs` 는 데모 하나만 남기고 지우므로 그것을 돌리면
> 여기서 만든 것도 사라진다.
